...
// [GenAI Use] Reflection: The response was a good cleanup. It swapped the CSS override for the Button component's built-in danger variant removed a one-off style and reused shared logic. I confirmed Delete still renders red through the variant rather than the deleted override. Better than my original approach since it keeps button styling centralized.
